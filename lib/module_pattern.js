 ...
 * (4) Private members are NEVER exposed directly. Rather a wrapper is used which then calls the private member. 
 * This is the main difference between module pattern and revealing module pattern.
 *
 * Cons:
 *
